...
public interface IEnergyTransport extends IEnergyProvider, IEnergyReceiver {
     ...
     * <p>
     * Values are:<br>
     * {@link InterfaceType#SEND} for sending only<br>
     * {@link InterfaceType#RECEIVE} for receiving only<br>
     * {@link InterfaceType#BALANCE} for sending and receiving, and the default state
     */

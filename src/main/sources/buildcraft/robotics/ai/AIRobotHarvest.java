...
public class AIRobotHarvest extends AIRobot {
    ...
    public void update() {
        ...
        if (delay++ > 20) {
            if (!BuildCraftAPI.getWorldProperty("harvestable")
                    .get(robot.worldObj, blockFound.x, blockFound.y, blockFound.z)) {
                setSuccess(false);
                terminate();
                return;
            }

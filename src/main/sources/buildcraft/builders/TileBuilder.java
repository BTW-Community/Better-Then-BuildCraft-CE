        ...
        for (BlockIndex b : path) {
            if (previous != null) {
                LaserData laser = new LaserData(
                        new Position(previous.x + 0.5, previous.y + 0.5, previous.z + 0.5),
        ...
        if (currentBuilder == null || (currentBuilder.isDone(this) || forceIterate)) {
            if (path != null && path.size() > 1) {
                if (currentPathIterator == null) {
                    ...
                    currentPathIterator = new PathIterator(
                            start,
                            it,
                ...
                if (currentBuilder != null && currentBuilder.isDone(this)) {
                    ...
                    if (bpt != null) {
                        recursiveBuilder = new RecursiveBlueprintBuilder(
                                bpt,
                                worldObj,
                                xCoord,
                                yCoord,
            ...
            return new PacketCommand(this, "setItemRequirements", new CommandWriter() {
                ...
                public void write(ByteBuf data) {
                    ...
                    for (RequirementItemStack rb : items) {
                        ...
                        data.writeMedium(
                                (rb.stack.hasTagCompound() ? 0x800000 : 0x000000) | Math.min(0x7FFFFF, rb.size));
